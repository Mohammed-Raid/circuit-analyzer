...
**Files:**
- Modify: `circuit_analyzer/xml.py:19` (dataclass import), `circuit_analyzer/xml.py:653-657` (`_Bloc`), `circuit_analyzer/xml.py:660-668` (add `_roles_du_bloc` after `_refs_du_bloc`), `circuit_analyzer/xml.py:706-713` (`_grouper_par_circuit`'s bloc construction)
...
In `circuit_analyzer/xml.py`, change the import line (currently line 19):
